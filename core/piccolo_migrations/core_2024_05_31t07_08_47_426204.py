...
async def forwards():
    manager = MigrationManager(
        migration_id=ID, app_name="core", description=DESCRIPTION
    )

    manager.add_table(
        class_name="UserGeolocation",
    ...
    manager.add_column(
        table_class_name="UserGeolocation",
        tablename="user_geolocation",
        column_name="user",
        db_column_name="user",
    ...
    manager.add_column(
        ...
        db_column_name="reference_point",
    ...
    manager.add_column(
        ...
        params={
            "default": TimestampCustom(
                year=2024, month=5, day=5, hour=7, second=47, microsecond=426204
            ),
            "null": True,
            "primary_key": False,
            "unique": False,
    ...
    manager.add_column(
        table_class_name="UserConfirmation",
        tablename="user_confirmation",
        column_name="code",
        db_column_name="code",
    ...
    manager.add_column(
        ...
        db_column_name="expiration_time",
        column_class_name="Timestamp",
        column_class=Timestamp,
        params={
            "default": TimestampNow(),
